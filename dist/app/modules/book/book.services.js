...
exports.deleteBookService = exports.updateBookService = exports.getBookByCategoryIdService = exports.getBookService = exports.getBooksService = exports.createBookService = void 0;
...
const createBookService = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!result) {
        throw new apiError_1.ApiError(http_status_1.default.BAD_GATEWAY, `Book created failed`);
    }
    return result;
});
...
const getBooksService = (paginationOptions, filters) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!result) {
        throw new apiError_1.ApiError(http_status_1.default.NOT_FOUND, 'Book fetched failed');
    }
    return {
        meta: {
            page,
...
exports.getBookByCategoryIdService = getBookByCategoryIdService;
const updateBookService = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!result) {
        throw new apiError_1.ApiError(http_status_1.default.BAD_REQUEST, 'Book update failed');
    }
    return result;
});
...
const deleteBookService = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!result) {
        throw new apiError_1.ApiError(http_status_1.default.BAD_REQUEST, 'Book delete failed');
    }
    return result;
});
